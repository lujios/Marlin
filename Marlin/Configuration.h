...
// Set standby for the unselected tool with M104/106/109 T...
  ...
  #define SINGLENOZZLE_STANDBY_TEMP   //Luj antes comentado
  #define SINGLENOZZLE_STANDBY_FAN    //Luj antes comentado
#endif
...
// @section pid temp
  ...
  //#define PID_EDIT_MENU           // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)       //Lujmemory
  //#define PID_AUTOTUNE_MENU       // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)   //Lujmemory
#endif
...
#define DELTA
  ...
  #define DEFAULT_SEGMENTS_PER_SECOND 100 //Luj 31/08/2018 antes 80
  ...
  #define DELTA_CALIBRATION_MENU     //Lujmemory   comentar para aumentar EEPROM
...
//#define ENDSTOP_INTERRUPTS_FEATURE          //Lujsensorless  Uso los pins 2, 3 y 19 que tienen capacidad de interrupcion. Pero es incompatible son SENSENRLESS.
...
#define INVERT_X_DIR false //Luj Hay que invertir para TMC2209. Con 4988 era true
...
#define MIN_SOFTWARE_ENDSTOPS  //Luj 31/08/2018  evita mover el HOTEND por debajo del 0 HEIGHT. Se puede anular por menu, ver README.md
 ...
 */
//#define LCD_BED_LEVELING    //Lujmemory   consume 1652 bytes si se activa.
 ...
 */
#define Z_SAFE_HOMING   //Lujhoming   
 ...
 *  Lujmemory. Consultar https://crosslink.io/marlin-2-0-memory-usage-by-feature/
 */
#define EEPROM_SETTINGS       // Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!    //Lujmemory
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.   //Lujmemory
...
#define PREHEAT_3_LABEL       "PETG"                               //LujPETG
 ...
 */
//#define NO_LCD_MENUS
#define SLIM_LCD_MENUS    //Lujmemory  activa libera 5552 bytes. Pero se produce error de compilacion, que se resolvio moviendo DISABLED(SLIM_LCD_MENUS) a #else en menu_delta_calibrate.cpp
